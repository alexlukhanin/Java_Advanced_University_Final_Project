...
public enum FacultyName {
    /*  "Faculty of " */
    BIOLOGY, GEOGRAPHY, ECONOMICS, ENGINEERING, MEDICINE, DENTISTRY, HEALTHCARE, PHILOLOGY, TECHNOLOGIES,
    HISTORY, MATHEMATICS, SOCIAL, PHYSICS, PHILOSOPHY, CHEMISTRY, LAW;
}
